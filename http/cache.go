...
// only for debug
func (c *CacheData) Dump() {
    fmt.Println("bakdir =", c.bakdir)
    fmt.Println("xml config set: ", c.xmls)
    fmt.Println("dbs config set: ", c.dbs)
    fmt.Println("svr config set: ", c.svrs)
